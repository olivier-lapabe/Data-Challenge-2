...
class Tester:
    ...
    def test(self, num_epochs):
        ...
        combined_dataset = torch.utils.data.ConcatDataset([training_dataloader.dataset, validation_dataloader.dataset])
        combined_dataloader = torch.utils.data.DataLoader(combined_dataset, batch_size=training_dataloader.batch_size, shuffle=True)
    ...
    def predict(self, test_dataloader):
        ...
        test_df.to_csv(f"{self.log_directory}/Data_Challenge.csv", header = None, index = None)           